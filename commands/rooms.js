...
exports.run = (client, message, args) => {
    let embed = new MessageEmbed()
        ...
        .setColor("#e6bc6a");
    axios
        .get("https://api.dogegarden.net/v1/popularRooms")
        .then(function (response) {
            ...
            rooms.forEach((room) => {
                ...
                embed.addField(
                    `🏠 ${room.name} 👥 ${room.numPeopleInside} ⏱️ ${msToTime(
                        withOffset
                    )}`,
                    ` **[➡️ Join Room](https://dogehouse.tv/room/${room.id})**\n${description}\n`
                );
            });
